...
export class GradeDialogComponent implements OnInit {
 ...
 showNotificationDanger(from, align){
  ...
  gestionGrade(){
    ...
    console.log(data)
    this.ds.addgrade(data).subscribe(data=>{
      this.message="Grade ajouté avec succès"
  ...
  updateGrade(){
    ...
    this.ds.updategrade(id,dataupdate).subscribe((response)=>
    {console.log(response)
      this.message="Grade modifié avec succès"
      this.showNotification('top','center')
